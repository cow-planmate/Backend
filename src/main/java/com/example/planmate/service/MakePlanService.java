...
public class MakePlanService {
    ...
    public MakePlanResponse makeService(int userId, String departure, int travelId, List<LocalDate> dates, int adultCount, int childCount) {
        ...
        TransportationCategory transportationCategory = transportationCategoryRepository.findById(travelId)
