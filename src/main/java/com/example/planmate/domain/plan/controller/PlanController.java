...
public class PlanController {
    ...
    @GetMapping("/{planId}")
    public ResponseEntity<GetPlanResponse> getPlan(Authentication authentication, @PathVariable("planId") UUID planId) throws AccessDeniedException {
        UUID userId = UUID.fromString(authentication.getName());
    ...
    public ResponseEntity<DeletePlanResponse> deletePlan(Authentication authentication, @PathVariable("planId") UUID planId) throws AccessDeniedException {
        UUID userId = UUID.fromString(authentication.getName());
    ...
    public ResponseEntity<ResignEditorAccessResponse> resignEditorAccess(Authentication authentication, @PathVariable("planId") UUID planId) throws IOException {
        UUID userId = UUID.fromString(authentication.getName());
    ...
    public ResponseEntity<RemoveEditorAccessByOwnerResponse> removeEditorAccessByOwner(Authentication authentication, @PathVariable("planId") UUID planId, @PathVariable("targetUserId") UUID targetUserId) throws IOException {
        UUID userId = UUID.fromString(authentication.getName());
    ...
    public ResponseEntity<GetEditorsResponse> getEditors(Authentication authentication, @PathVariable("planId") UUID planId) throws AccessDeniedException {
        UUID userId = UUID.fromString(authentication.getName());
    ...
    public ResponseEntity<InviteUserToPlanResponse> inviteUserToPlan(Authentication authentication, @PathVariable("planId") UUID planId, @RequestBody InviteUserToPlanRequest request) throws IOException {
        UUID userId = UUID.fromString(authentication.getName());
    ...
    public ResponseEntity<RequestEditAccessResponse> requestEditAccess(Authentication authentication, @PathVariable("planId") UUID planId) throws IOException {
        UUID userId = UUID.fromString(authentication.getName());
