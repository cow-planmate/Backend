...
public class PasswordService {
    ...
    public VerifyPasswordResponse verifyPassword(String userId, String password) {
    ...
    @Transactional
    public ChangePasswordResponse changePassword(String userId, String password, String confirmPassword) {
